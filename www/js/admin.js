...
__webpack_require__("./node_modules/trumbowyg/dist/plugins/upload/trumbowyg.upload.js");
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('document').ready(function () {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('textarea.turmbowyg').trumbowyg({
        autogrow: true,
        ...
        ['justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull'], ['unorderedList', 'orderedList'], ['horizontalRule'], ['removeformat'], ['fullscreen']],
        plugins: {
...
app.General = function () {
     ...
     * simple function
     */
    var adminSimpleDataTable = function adminSimpleDataTable() {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#adminSimpleDataTable').DataTable();
        });
    };
     ...
     */
    var confirmDeleteItem = function confirmDeleteItem() {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('a.need-confirm').click(function () {
                var itemName = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).data('item');
                if (confirm('Точно удалить ' + itemName + '?')) {
                    location.href = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('href') + '/' + __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).data('id');
                }
                return false;
            });
        });
...
app.Product = function () {
    var initDataTable = function initDataTable() {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function () {
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#brandFilterSelect').on('change select', function () {
                table.column(3).search(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val()).draw();
            });
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#avaiabilityFilterSelect').on('change select', function () {
                table.column(4).search(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val(), false, false, false).draw();
            });
        });
    };
