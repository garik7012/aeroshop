            ...
            <div class="product-col" data-match-height="featured">
                ...
                <div class="prod-info">
                    <div class="product-buttons">
                        ...
                        <div class="button1"><a class="btn products-button" href="#36"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Details&nbsp;</span></a></div>
                    </div>
                </div>
            </div>
        </li>
