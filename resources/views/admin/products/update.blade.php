...
@section('content')
    ...
    <section class="content">
                    ...
                    <form role="form" action="{{route('admin.products.update', $product->id)}}" method="post">
                        <div class="box-body">
                            <div class="form-group {{ $errors->has('ru_title') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name='ru_title' class="form-control" id="InputRuTitle" value="{{old('ru_title') ?: $product['ru_title']}}">
                            ...
                            <div class="form-group {{ $errors->has('uk_title') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name='uk_title' class="form-control" id="InputUkTitle" value="{{old('uk_title') ?: $product['uk_title']}}">
                            ...
                            <div class="form-group {{ $errors->has('en_title') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name='en_title' class="form-control" id="InputEnTitle" value="{{old('en_title') ?: $product['en_title']}}">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-4 {{ $errors->has('price') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" name='price' class="form-control" id="InputPrice" value="{{old('price') ?: $product['price']}}">
                                    @if ($errors->has('price'))
                                        <span class="help-block">
                                ...
                                <div class="form-group col-xs-4 {{ $errors->has('unit_id') ? ' has-error' : '' }}">
                                    ...
                                    <select name="unit_id" class="form-control" id="SelectUnit">
                                        @foreach($units as $unit)
                                            <option value="{{$unit->id}}" {{$product->unit_id == $unit->id ? 'selected' : ''}}>{{$unit->ru_title}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group {{ $errors->has('availability_id') ? ' has-error' : '' }}">
                                ...
                                <select name="availability_id" class="form-control" id="SelectCategory">
                                    @foreach(\App\Models\Availability::all() as $availability)
                                        <option value="{{$availability->id}}" {{$product->availability_id == $availability->id ? 'selected' : ''}}>{{$availability->ru_title}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('url') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name='url' disabled class="form-control" id="InputURL" value="{{old('url') ?: $product['url']}}">
                                @if ($errors->has('url'))
                                    <span class="help-block">
                            ...
                            <div class="form-group {{ $errors->has('youtube') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="youtube" class="form-control" id="InputYoutube" value="{{old('youtube') ?: $product['youtube']}}">
                            ...
                            <div class="form-group {{ $errors->has('code') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="code" class="form-control" id="InputCode" value="{{old('code') ?: $product['code']}}">
                                @if ($errors->has('code'))
                                    <span class="help-block">
                            ...
                            <div class="form-group {{ $errors->has('category_id') ? ' has-error' : '' }}">
                                ...
                                <select name="category_id" class="form-control" id="SelectCategory">
                                    ...
                                    <option value="{{$category->id}}" {{$product->category_id == $category->id ? 'selected' : ''}}>{{$category->ru_title}}
                            ...
                            <div class="form-group {{ $errors->has('country_id') ? ' has-error' : '' }}">
                                ...
                                <select name="country_id" class="form-control">
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{$country->id}}" {{$product->country_id == $country->id ? 'selected' : ''}}>{{$country->ru_title}}</option>
                                    @endforeach
                                </select>
        ...
        @include('admin.products._lang')
        @include('admin.products._properties')
    </section>
    <!-- /.content -->
@endsection